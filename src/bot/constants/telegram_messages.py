...
MONEY_LEFT_HAS = 'Осталось до конца месяца: {}'

MONEY_RAN_OUT = 'Перерасход бюджета: {}❗️'

UPDATE_MESSAGE = '✅ Зачислено <b>{}</b> денег в категорию <b>{}</b>. '
...
DELETE_MESSAGE = (
    '❌ Трата на сумму <b>{}</b> денег в категории {} была <b>удалена</b>. '
)
...
TODAY_EXPENSES = '💸 Сегодня было потрачено: {} денег.'
TOO_MANY_MONEY_BRUH = ' 🗿'
IN_CATEGORIES_LABEL = '\nВ категориях:'
CATEGORY_ITEM = '- {} - {}'
