...
SPEND_EXPENSE_TO_API_LOG = "User {} add expense {} to category {} to the API, money left: {}"
...
CURRENCY_INCORRECT_CODE_LOG = "User {} tried to add currency with incorrect currency code: {}"
CURRENCY_ADDED_NEW_LOG: str = "User {} added the new currency: {}"

CURRENCY_NOT_UNIQUE_LOG: str = "User {} tried to add not unique currency"
CURRENCY_COUNTRY_TOO_LONG_LOG: str = "User {} tried to add currency with too long country name: {}"
